    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col">
      ...
      <nav className="px-4 py-4 flex justify-between items-center shadow-sm bg-white lg:px-8">
        <div className="flex items-center space-x-3">
          <IconQrcode className="text-blue-600" size={32} />
        ...
        {activeTab === "features" && (
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className="bg-blue-100 w-12 h-12 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mb-3 lg:mb-4">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
            {howItWorks.map((step) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className="bg-blue-100 w-12 h-12 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mb-3 lg:mb-4">
                    <div className="text-blue-600 text-xl lg:text-2xl font-bold">
                      {step.step}
                    </div>
                  </div>
                  <h3 className="text-lg lg:text-xl font-semibold text-gray-800 mb-2 lg:mb-3">
        ...
        <section className="mt-16 lg:mt-24 bg-white rounded-xl shadow-lg p-6 lg:p-16">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
            <div className="flex items-start space-x-4">
              <IconAward className="text-blue-600 mt-1" size={28} />
              <div>
            ...
            <div className="flex items-start space-x-4">
              <IconShoppingBag className="text-blue-600 mt-1" size={28} />
              <div>
                <h3 className="text-lg lg:text-xl font-semibold mb-2 text-gray-800">
            ...
            <div className="flex items-start space-x-4">
              <IconCheck className="text-blue-600 mt-1" size={28} />
              <div>
                <h3 className="text-lg lg:text-xl font-semibold mb-2 text-gray-800">
                  Always Up-to-Date
                </h3>
            ...
            {pricingPlans.map((plan, index) => (
              ...
              >
                <div className="mb-4">
                  ...
                  {plan.recommended && (
                    <span className="text-sm bg-blue-100 text-blue-600 px-2 py-1 rounded mt-2 inline-block">
                      Most Popular
                    </span>
                  )}
                </div>
                <ul className="space-y-3 mb-6">
                  {plan.features.map((feature, idx) => (
                    <li key={idx} className="flex items-center">
                      <IconCheck className="text-blue-500 mr-2" size={20} />
      ...
      {/* Call to Action */}
      <section className="bg-blue-600 text-white py-12 lg:py-16 text-center px-4">
        ...
        <div className="space-x-4">
          <button className="bg-white text-blue-600 px-6 lg:px-8 py-2 lg:py-3 rounded-lg hover:bg-blue-50 transition text-sm lg:text-base">
            Start Free
          </button>
          <button className="border border-white text-white px-6 lg:px-8 py-2 lg:py-3 rounded-lg hover:bg-blue-700 transition text-sm lg:text-base">
            Learn More
          </button>
        </div>
      </section>
      ...
      <footer className="bg-gray-800 text-white py-6 lg:py-8 px-4 lg:px-8">
        <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
          ...
          <div className="space-x-4">
            <a href="#" className="text-sm lg:text-base hover:text-blue-300">
              Privacy
            </a>
            <a href="#" className="text-sm lg:text-base hover:text-blue-300">
              Terms
